...
const CrearNoDocente = () => {
  ...
  const crearNuevoDocente= async () => {
    ...
    try {
      ...
      const existeRegistro = await axios.get(`http://127.0.0.1:8000/facet/api/v1/nodocentes/${idPersona}`);
      ...
      if (axios.isAxiosError(error) && error.response && error.response.status === 404) {
        ...
        const response = await axios.post('http://127.0.0.1:8000/facet/api/v1/nodocentes/', nuevoDocente, {
          headers: {
